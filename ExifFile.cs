...
namespace ExifLibrary
{
    ...
    public class ExifFile
    {
        ...
        private void ReadAPP1()
        {
            ...
            JPEGSection app1 = null;
            foreach (JPEGSection a in file.Sections)
                if((a.Marker == JPEGMarker.APP1) && (Encoding.ASCII.GetString(a.Header, 0, 6) == "Exif\0\0"))
                    app1 = a;
            ...
            if (app1 == null)
            {
                ...
                for(int i=0;i<file.Sections.Count;i++)
                    if(file.Sections[i].Marker == JPEGMarker.APP0)
                        insertionIndex = i;
